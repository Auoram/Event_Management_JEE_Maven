<%-- 
    Document   : events
    Created on : 13 juin 2025, 15:35:17
    Author     : lenovo
--%>
...
<body>
    ...
    <div class="container mt-4">
        <% if ("admin".equals(((com.last.entities.User)session.getAttribute("user")).getRole())) { %>
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                %>
                    <tr>
                        <td><%= event.getName() %></td>
                        <td><%= event.getDate().format(displayFormatter) %></td>
                        ...
                        <% if ("admin".equals(((com.last.entities.User)session.getAttribute("user")).getRole())) { %>
                            <td>
                                <button class="btn btn-sm btn-warning" data-bs-toggle="modal" 
                                    ...
                                    data-date="<%= event.getDate().format(inputFormatter) %>"
